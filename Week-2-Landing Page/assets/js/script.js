...
const showMenu = (toggleId, navId) => {
    ...
    if(toggle && nav) {
        toggle.addEventListener('click', () => {
            // we add show-menu class to the div tag the nav__menu class
...
// We validate if user previously chose topic
if (selectedTheme) {
    // if validation is fulfilled, we ask what the issue was to know if we activated or diactivated the dark
...
sr.reveal(`.home__data, .home__img, .decoration__data, .accessory__content, .footer__content`, {origin: 'top', interval: 200})
